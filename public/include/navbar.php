...
<nav class="fixed top-0 flex w-full items-center justify-between px-4 py-3 lg:px-8 bg-transparent z-50 backdrop-blur duration-500 supports-backdrop-blur:bg-white/60" aria-label="Global">
    ...
    <?php if (isset($_SESSION["user"]["email"])): ?>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-gray-900 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center hover:text-blue-500 focus:text-blue-500 transition-all duration-150" type="button">
        ...
        <div id="dropdownDivider" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDividerButton">
                <li>
                    <a href="#" class="flex flex-row items-center px-4 py-2 text-sm text-gray-900 hover:font-semibold transition-all duration-150">
                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 448 512">
            ...
            <div class="py-2">
                <a href="/public/pages/logoat.php" class="flex flex-row items-center px-4 py-2 text-sm text-red-700 hover:font-semibold hover:text-red-600 transition-all duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="flex-shrink h-4 w-4 mr-2" viewBox="0 0 512 512">
